...
draftRevisionsProvider =
    ...
    >((ref, record) async {
      return ref
          .watch(draftRepositoryProvider)
          .listRevisions(record.caseId, record.draftId, record.paragraphId);
    });
...
draftReviewsProvider =
    ...
    >((ref, record) async {
      return ref
          .watch(draftRepositoryProvider)
          .listReviews(record.caseId, record.draftId, record.paragraphId);
    });
