...
class PrecedentBenchmarkTests(unittest.TestCase):
    ...
    def test_usable_precision_above_80(self) -> None:
        self.assertGreaterEqual(self.result["usable_precision"], 80.0,
            f"Precision {self.result['usable_precision']}% below 80%")
